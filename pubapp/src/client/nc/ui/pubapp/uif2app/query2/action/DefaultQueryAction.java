package nc.ui.pubapp.uif2app.query2.action;
...
public class DefaultQueryAction extends NCAction implements IQueryAreaCreator {
	...
	public QueryArea createQueryArea() {
		...
		if (this.qryCondDLGDelegator == null) {
			queryAreaDelegator = new QueryConditionDLGDelegator(iQcd,
					getModel().getContext());
		}

		this.initQueryConditionDLG(queryAreaDelegator);
		QueryArea qa = iQcd.createQueryArea();
	...
	public void doSimpleSchemeQuery(final SimpleQuerySchemeVO vo) {
		...
		if (!hasQueryArea) {
			...
			synchronized (DefaultQueryAction.this) {
				if (!this.queryareaInit) {
					SwingWorker<Object, Object> sw = new SwingWorker<Object, Object>() {
						@Override
						protected Object doInBackground() throws Exception {
							do {
								Thread.sleep(100);
							} while (!DefaultQueryAction.this.queryareaInit);
							return null;
						}
