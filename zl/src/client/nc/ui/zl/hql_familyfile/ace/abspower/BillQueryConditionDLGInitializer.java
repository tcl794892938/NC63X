package nc.ui.zl.hql_familyfile.ace.abspower;
...
import nc.ui.zl.abs.power.FilterFormattypeByOrg;
...
public class BillQueryConditionDLGInitializer implements
	...
	public void initQueryConditionDLG(QueryConditionDLGDelegator dlgDelegator) {
		...
		String[] baseDoc=new String[]{"pk_projectid"};
		...
		String[] baseDoc1=new String[]{"pk_formattypeid"};
		for(int i=0;i<baseDoc1.length;i++){
			FilterFormattypeByOrg baseDocByOrgFileter = 
					new FilterFormattypeByOrg(dlgDelegator,"pk_org",baseDoc1[i]); 
			baseDocByOrgFileter.addEditorListener();
		}
