package nc.ui.zl.hql_entryacceptance.ace.abspower;
...
public class BillQueryConditionDLGInitializer implements
	...
	public void initQueryConditionDLG(QueryConditionDLGDelegator dlgDelegator) {
		...
		String[] baseDoc3 = new String[] { "pk_entryacceptance_khfc.pk_customer" };
		...
		String[] baseDoc4 = new String[] { "pk_entryacceptance_khfc.pk_housesource" };
		for (int i = 0; i < baseDoc4.length; i++) {
			FilterHouseByBuilding baseDocByOrgFileter = new FilterHouseByBuilding(
					dlgDelegator, "pk_entryacceptance_khfc.pk_buildingfile", baseDoc4[i]);
			baseDocByOrgFileter.addEditorListener();
		}
		
		String[] baseDoc5 = new String[] { "pk_entryacceptance_khfc.pk_buildingfile" };
