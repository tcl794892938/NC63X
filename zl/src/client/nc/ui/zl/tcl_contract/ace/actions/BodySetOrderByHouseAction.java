 ...
 */
public class BodySetOrderByHouseAction extends AbstractBodyTableExtendAction {
	/**
	 * @author:August
	...
	private Icon maxicon = ThemeResourceCenter.getInstance().getImage("themeres/ui/toolbaricons/move_up.png");

	public BodySetOrderByHouseAction() {
		this.setCode("bodysethouse");
		this.setIcon(this.maxicon);
		// 设置提示
		this.putValue(Action.SHORT_DESCRIPTION, "按房产排序");
