...
public class ExportAction2 extends NCAction {
	...
	public void doAction(ActionEvent arg0) throws Exception {
		int a=billForm.getBillCardPanel().getBillModel("report_cwdy").getRowCount();
		if(a<=0){
			MessageDialog.showHintDlg(model.getContext().getEntranceUI(), "提示", "界面无数据，不可导出！");
			return ;
		}
		new ExportAction(billForm.getBillCardPanel().getBodyValueAt(0, "pk_org").toString(),billForm.getBillCardPanel(), exportname);
