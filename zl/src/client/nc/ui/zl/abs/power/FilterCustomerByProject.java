...
public class FilterCustomerByProject extends AbstractLinkageColumnListener{
	...
	public FilterCustomerByProject(QueryConditionDLGDelegator dlg, String orgField, String basedocField) {
		super(dlg);
		this.orgField = orgField;
		this.targetField = basedocField;
	}

	public FilterCustomerByProject(QueryConditionDLGDelegator dlg, String orgField, String basedocField, String filterField) {
