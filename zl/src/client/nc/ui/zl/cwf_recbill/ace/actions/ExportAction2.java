...
public class ExportAction2 extends NCAction{
	...
	public void doAction(ActionEvent arg0) throws Exception {
		...
		RecbillVO[] vos = (RecbillVO[])listView.getBillListPanel().getHeadBillModel().getBodyValueVOs(RecbillVO.class.getName());
		...
		new ExportListAction(listView.getBillListPanel(),code, "应收单导出");
	}
