...
public class BillKPDJServiceImpl implements IBillReflectorService{
	...
	public Collection<FipExtendAggVO> queryBillByRelations(
		    ...
		    BillQuery<AggKpregisterVO> query = new BillQuery<AggKpregisterVO>(AggKpregisterVO.class);
		    AggKpregisterVO[] bills = query.query(hids);
		    // 加锁
	...
	private Collection<FipExtendAggVO> createFipMsgVO(AggKpregisterVO[] vos) {
	    Collection<FipExtendAggVO> msgvolist = new ArrayList<FipExtendAggVO>();
	    for (AggKpregisterVO vo : vos) {
