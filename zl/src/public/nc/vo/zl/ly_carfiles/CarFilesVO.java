...
public class CarFilesVO extends SuperVO {
/**
*单据类型编码
*/
...
* @return 主键
*/
public String getPk_carfiles () {
return this.pk_carfiles;
 } 

/** 
* 设置主键
*
* @param pk_carfiles 主键
*/
public void setPk_carfiles ( String pk_carfiles) {
this.pk_carfiles=pk_carfiles;
 } 
...
this.vdef5=vdef5;
  ...
  public IVOMeta getMetaData() {
    return VOMetaFactory.getInstance().getVOMeta("zl.carfiles");
  }
}