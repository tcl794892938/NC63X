...
public class BslistVO extends SuperVO {
/**
*接单部门
*/
...
* @return 主键
*/
public String getPk_bslist () {
return this.pk_bslist;
 } 
...
* @param pk_bslist 主键
*/
public void setPk_bslist ( String pk_bslist) {
this.pk_bslist=pk_bslist;
 } 
...
this.vdef5=vdef5;
  ...
  public IVOMeta getMetaData() {
    return VOMetaFactory.getInstance().getVOMeta("zl.bslist");
  }
}