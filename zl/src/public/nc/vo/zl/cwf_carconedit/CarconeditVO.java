...
public class CarconeditVO extends SuperVO {
/**
*审核批语
*/
...
* @return 项目
*/
public String getPk_poject () {
return this.pk_poject;
 } 
...
* @param pk_poject 项目
*/
public void setPk_poject ( String pk_poject) {
this.pk_poject=pk_poject;
 } 
...
* @return 来源单据号
*/
public String getVsrcbcode () {
return this.vsrcbcode;
 } 

/** 
* 设置来源单据号
*
* @param vsrcbcode 来源单据号
*/
public void setVsrcbcode ( String vsrcbcode) {
this.vsrcbcode=vsrcbcode;
 } 
...
this.vsrcbtype=vsrcbtype;
  ...
  public IVOMeta getMetaData() {
    return VOMetaFactory.getInstance().getVOMeta("zl.carconedit");
  }
}