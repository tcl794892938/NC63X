...
public class ContractYwcfVO extends SuperVO {
/**
*租金截止日期
*/
...
*是否期初
*/
public UFBoolean is_qc;
/**
*租约金额
*/
public UFDouble nqzmny;
/**
*已收金额
*/
...
*主键
*/
public String pk_contract_ywcf;
/**
*收费项目
*/
...
* @param is_qc 是否期初
*/
public void setIs_qc ( UFBoolean is_qc) {
this.is_qc=is_qc;
 } 
...
* @param nqzmny 租约金额
*/
public void setNqzmny ( UFDouble nqzmny) {
this.nqzmny=nqzmny;
 } 
...
* @return 主键
*/
public String getPk_contract_ywcf () {
return this.pk_contract_ywcf;
 } 

/** 
* 设置主键
*
* @param pk_contract_ywcf 主键
*/
public void setPk_contract_ywcf ( String pk_contract_ywcf) {
this.pk_contract_ywcf=pk_contract_ywcf;
 } 
...
this.vmemo=vmemo;
  ...
  public IVOMeta getMetaData() {
    return VOMetaFactory.getInstance().getVOMeta("zl.contract_ywcf");
  }
}