...
public class ContractZqmxVO extends SuperVO {
...
*主键
*/
public String pk_contract_zqmx;
/**
*行号
*/
public String rowno;
...
this.vmemo=vmemo;
  ...
  public IVOMeta getMetaData() {
    return VOMetaFactory.getInstance().getVOMeta("zl.contract_zqmx");
  }
...
public String getPk_contract_zqmx() {
	return pk_contract_zqmx;
}

public void setPk_contract_zqmx(String pk_contract_zqmx) {
	this.pk_contract_zqmx = pk_contract_zqmx;
}
}