...
public class ContractCwcfVO extends SuperVO {
/**
*费用截止日期
*/
...
*主键
*/
public String pk_contract_cwcf;
...
* @return 主键
*/
public String getPk_contract_cwcf () {
return this.pk_contract_cwcf;
 } 

/** 
* 设置主键
*
* @param pk_contract_cwcf 主键
*/
public void setPk_contract_cwcf ( String pk_contract_cwcf) {
this.pk_contract_cwcf=pk_contract_cwcf;
 } 
...
this.vmemo=vmemo;
  ...
  public IVOMeta getMetaData() {
    return VOMetaFactory.getInstance().getVOMeta("zl.contract_cwcf");
  }
