...
public class Throwalease_zqfyqsVO extends SuperVO {
/**
*费用截止日期
*/
...
*费用清算主键
*/
public String pk_throwalease_zqfyqs;
/**
*行号
*/
public String rowno;
...
public String getPk_throwalease_zqfyqs() {
	return pk_throwalease_zqfyqs;
}

public void setPk_throwalease_zqfyqs(String pk_throwalease_zqfyqs) {
	this.pk_throwalease_zqfyqs = pk_throwalease_zqfyqs;
}
...
this.vdef5=vdef5;
  ...
  public IVOMeta getMetaData() {
    return VOMetaFactory.getInstance().getVOMeta("zl.throwalease_zqfyqs");
  }
}