package nc.vo.zl.hql_contracttype;
...
public class ContracttypeVO extends SuperVO {
/**
*类型编码
*/
public String code;
...
this.vdef5=vdef5;
  ...
  public IVOMeta getMetaData() {
    return VOMetaFactory.getInstance().getVOMeta("zl.contracttype");
  }
}