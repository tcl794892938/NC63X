...
public class UpcontractVO extends SuperVO {
/**
*租金总金额
*/
...
this.vsrctype=vsrctype;
  ...
  public IVOMeta getMetaData() {
    return VOMetaFactory.getInstance().getVOMeta("zl.upcontract");
  }
}